            ...
            <div className="border-b border-gray-200 px-1 sm:px-2 lg:px-6 overflow-hidden">
              <TabsList className="h-auto p-0 bg-transparent w-full justify-start">
                <div className="flex space-x-1 sm:space-x-2 lg:space-x-4 overflow-x-auto scrollbar-hide pb-1 w-full min-w-0">
                  ...
                  <TabsTrigger 
                    value="users" 
                    className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-green-600 rounded-none px-1 sm:px-2 lg:px-3 py-3 sm:py-4 text-xs sm:text-sm whitespace-nowrap flex-shrink-0 min-w-0"
                  >
                    <Users className="h-3 w-3 sm:h-4 sm:w-4 mr-1 flex-shrink-0" />
